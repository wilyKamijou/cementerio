...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware(['permiso:ver_empleados'])->group(function () {
        ...
        Route::get('/empleados/{id}/edit', [EmpleadoController::class, 'edit'])->name('empleados.edit')->middleware('permiso:editar_empleado');
    ...
    Route::prefix('admin')->name('admin.')->middleware(['permiso:ver_cementerios'])->group(function () {
        Route::get('/cementerios', [CementerioController::class, 'index'])->name('cementerios.index');
        Route::get('/cementerios/create', [CementerioController::class, 'create'])->name('cementerios.create')->middleware('permiso:crear_cementerio');
        Route::post('/cementerios', [CementerioController::class, 'store'])->name('cementerios.store')->middleware('permiso:crear_cementerio');
        Route::get('/cementerios/{id}/edit', [CementerioController::class, 'edit'])->name('cementerios.edit')->middleware('permiso:editar_cementerio');
        Route::put('/cementerios/{id}', [CementerioController::class, 'update'])->name('cementerios.update')->middleware('permiso:editar_cementerio');
        Route::delete('/cementerios/{id}', [CementerioController::class, 'destroy'])->name('cementerios.destroy')->middleware('permiso:eliminar_cementerio');
    });
